...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final exploreButtonStyle = ElevatedButton.styleFrom(
      padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 16),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
    );

    final outlinedWhiteButtonStyle = OutlinedButton.styleFrom(
                          ...
                          Wrap(
                            ...
                            children: [
                              ElevatedButton.icon(
                                ...
                                label: const Text('Explore Florida Spots'),
                                style: exploreButtonStyle,
                              ),
                              OutlinedButton.icon(
                                onPressed: () {}, // hook up your action
                                icon: const Icon(Icons.park),
                                label: const Text('Join Florida Anglers'),
                  ...
                  Wrap(
                    ...
                    children: [
                      ElevatedButton.icon(
                        onPressed: () => Navigator.pushNamed(context, '/signup'),
                        icon: const Icon(Icons.park),
                        label: const Text('Start Fishing Florida'),
                      ...
                      OutlinedButton.icon(
                        onPressed: () => Navigator.pushNamed(context, '/map'),
                        icon: const Icon(Icons.map),
                        label: const Text('Explore Orlando Spots'),
                        style: outlinedWhiteButtonStyle,
                      ),
                    ],
                  ),
  ...
  static Widget _footerLinks(String heading, List<String> links) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
